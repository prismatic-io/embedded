...
The code for the page is available in `src/routes/examples/chat-bot.tsx`, and the chatbot backend that fetches tools is implemented in `src/plugins/acme-chat-bot.ts`.
