...
Fully control how your customers browse integrations. This page runs a `marketplaceIntegrations` query with `prismatic.graphqlRequest()` and renders the results in your own components - so the marketplace feels native to your app instead of an iframe.
